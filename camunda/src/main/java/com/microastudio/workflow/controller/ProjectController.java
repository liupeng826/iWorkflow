package com.microastudio.workflow.controller;
import com.microastudio.workflow.camunda.process.constant.ProjectProcessConstant;
import com.microastudio.workflow.util.StringPareseMap;
...
public class ProjectController {
    ...
    private static class ProjectParticipateRequestRecord {
        ...
        String projectParticipateId;

        String taskId;

        public String getProjectParticipateId() {
        ...
        public void setProjectParticipateId(String projectParticipateId) {
    ...
    /*
        ...
        *
         * @param schoolName
     * @param reviewLevel
        * @return java.util.List<com.microastudio.workflow.controller.ProjectController.ProjectParticipateRequestRecord>
        * @throws
        * @Author hpz
    ...
    public @ResponseBody List<ProjectParticipateRequestRecord> getAllProjectParticipateRequest(String schoolName, Integer reviewLevel) {
        ...
        tasks.forEach( task -> {
            ...
            String recordId = ""+ variables.get(ProjectProcessConstant.FORM_RECORD_ID);
    ...
    /*
        ...
        *
         * @param userId
        * @return java.util.List<com.microastudio.workflow.controller.ProjectController.UploadExtraInfoRecord>
        * @throws
        * @Author hpz
        * @date 2019-6-12 17:29
        * @see [相关类/方法](可选)
